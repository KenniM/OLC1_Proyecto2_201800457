...
import StringNode from '/src/node/string';
import TableNode from '/src/node/table';
import ArrayNode from '/src/node/array';

import TreeLayout from '/src/layout/tree';
import ArrayLayout from '/src/layout/array';

import ObjectReader from '/src/reader/object';

import { visitAfter } from '/src/util';
...
g.vtree-node rect.number-text { fill: #fcf5e1; }
g.vtree-node rect.string-text { fill: #f0e8db; }
g.vtree-node rect.boolean-text { fill: #f0d8d8; }
